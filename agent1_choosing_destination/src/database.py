...
DB_PATH = "/Users/trannguyenmyanh/Documents/TripMind/agent1_choosing_destination/tripmind_vector_db" #fixed data path 
...
def ingest_to_chromadb(file_path, model, assets, device, batch_size=100):
    client = chromadb.PersistentClient(path="/Users/trannguyenmyanh/Documents/TripMind/agent1_choosing_destination/tripmind_vector_db") #fix datapath
